package seedu.pharmhub.commons.core;
...
public class LogsCenter {
    ...
    private static final String LOG_FILE = "pharmHub.log";
    ...
    /**
     * Creates a logger named 'PharmHub', containing a {@code ConsoleHandler} and a {@code FileHandler}.
     * Sets it as the {@code baseLogger}, to be used as the parent logger of all other loggers.
     */
    private static void setBaseLogger() {
        baseLogger = Logger.getLogger("PharmHub");
