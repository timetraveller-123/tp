...
import static seedu.pharmhub.logic.Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonPharmHubStorage pharmHubStorage =
                new JsonPharmHubStorage(temporaryFolder.resolve("pharmHub.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(pharmHubStorage, userPrefsStorage);
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an PharmHubStorage that throws the IOException e when saving
        JsonPharmHubStorage pharmHubStorage = new JsonPharmHubStorage(prefPath) {
            @Override
            public void savePharmHub(ReadOnlyPharmHub pharmHub, Path filePath)
                    throws IOException {
                throw e;
            }
        };
        ...
        // Triggers the savePharmHub method by executing an add command
